...
public class TopicDomain {
    ...
    public CallResult<Object> practice() {
        ...
        TopicDTO topic = this.topicDomainRepository.findTopicAnswer(userId, topicId, userHistory.getId());
    ...
    private CallResult startNewStudy(Long subjectId,Long userId,String topicAreaPro) {
        ...
        TopicDTO topic = this.topicDomainRepository.findTopicAnswer(userId, topicIdList.get(0), userHistory.getId());
    ...
    public CallResult<Object> submit() {
        ...
        UserProblemDomain userProblemDomain = this.topicDomainRepository.createUserProblemDomain(null);
